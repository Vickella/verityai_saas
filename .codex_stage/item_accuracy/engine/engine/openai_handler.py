...
- When product wording or the exact item code is uncertain, use search_product_catalog before requesting a price or quotation. For every quotation item, pass the exact item_code returned by the catalogue and preserve the visitor's original need in requested_description. Never choose a loosely related product merely because it has a price. Never invent catalogue items, prices, pipeline records, appointments, or customer activity.
					...
					"function": {
						...
						"parameters": {
							...
							"properties": {
								...
								"items": {"type": "array", "items": {"type": "object", "properties": {"item_code": {"type": "string", "description": "Exact item code returned by search_product_catalog."}, "requested_description": {"type": "string", "description": "The visitor's original requested product, service, outcome, or scope in their own words."}, "qty": {"type": "number"}}, "required": ["item_code", "requested_description", "qty"]}},
