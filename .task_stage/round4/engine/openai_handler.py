	...
	tool_defs = [
		...
		},
		{
			...
			"function": {
				...
				"description": "Get tenant-specific dynamic lead fields based on the tenant business nature before asking qualification questions.",
