...
def ensure_doctypes():
	...
	ensure_doctype("VerityAI WhatsApp Message", [
		...
		field("message", "Message", "Small Text", reqd=1),
		field("delivery_method", "Delivery Method", "Select", options="Text\nTemplate", default="Text"), field("template_name", "Template Name"),
	...
	ensure_doctype("VerityAI WhatsApp Setup", [
		...
		field("reengagement_template_name", "Follow-up Template Name"),
		field("reengagement_template_language", "Follow-up Template Language", default="en_US"),
		field("reengagement_template_status", "Follow-up Template Status", "Select", options="Not Configured\nNot Checked\nApproved\nRejected", default="Not Configured", read_only=1),
	...
	ensure_doctype("VerityAI ERPNext Accounting Settings", [
		...
		field("credits_per_currency_unit", "Calculated Provider Credits per USD", "Float", default=0),
