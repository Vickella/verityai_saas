(() => {
  ...
  const pill = (value) => `<span class="va-pill ${["Active","Connected","Done","Normal","Trial","Healthy"].includes(value)?"good":["Failed","Suspended","Exhausted","Critical"].includes(value)?"bad":""}">${esc(value || "â€”")}</span>`;
