...
def create_workspace(owner_user, account_name, workspace_name, business_name=None, plan_name=None, values=None):
	...
	try:
		...
		member = frappe.get_doc({"doctype": "VerityAI Workspace Member", "workspace": workspace.name, "user": owner_user, "workspace_role": "Owner", "status": "Active", "can_manage_assistant": 1, "can_manage_widget": 1, "can_manage_knowledge": 1, "can_view_leads": 1, "can_manage_leads": 1, "can_view_campaigns": 1, "can_manage_campaigns": 1, "can_view_conversations": 1, "can_manage_conversations": 1, "can_manage_billing": 1, "can_manage_whatsapp": 1, "can_manage_email": 1, "can_approve_quotes": 1, "can_view_customers": 1, "can_manage_customers": 1, "can_view_catalog": 1, "can_manage_catalog": 1, "can_view_quotes": 1, "can_manage_quotes": 1, "can_view_website": 1, "can_manage_website": 1}).insert(ignore_permissions=True)
